...
#define CONFIGURER_TYPE 3 

#if CONFIGURER_TYPE == 1
...
void setup() {
    Serial.begin(921600);
    Serial.println();
    Serial.println("EnigmaIOT Node Configurer");
    Serial.println();
    time_t start = millis();
    ...
    EnigmaIOTNode.begin(&Espnow_hal, NULL, NULL, true, true, configurer);
    ...
    Serial.printf("Total time: %llu ms\n", millis() - start);
